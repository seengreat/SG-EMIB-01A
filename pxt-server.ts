...
/**
 * Well known colors for a NeoPixel strip,This section of the code refers to:
...
namespace neopixel {
    ...
    */
    ...
    // /**
    //  * Set LED to a given color (range 0-255 for r, g, b).
    //  * @param mode LED display color in music rhythm
    //  * @param vol_sample The volume sampling amplitude of the microphone
    //  */
    // //% blockId="neopixel_set_pixel_color" block="%strip|set pixel color at %pixeloffset|to %rgb=neopixel_colors"
    // //% strip.defl=strip
    // //% blockGap=8
    // //% weight=80
    // //% parts="neopixel" advanced=true
    // export function music_rhythm(mode: Music_Rhythm_Mode, vol_sample:number[], vol_array_len:number): void {
    //     vol_sample.sort(function(a,b){return a-b})
    //     let max = vol_sample[11] //the lenght of vol_sample
    //     mic.push(max)
    //     mic.shift()
    //     m++
    //     if (m == 7) {
...
namespace Sound_volume {
    ...
    /**
     * get adc value from the P3;
     */
    //% blockId=Sound_getADCValue block="get sound adc value"
    //% weight = 85
    ...
    /**
     * get volt value from the P3;
     */
    //% blockId=Sound_getVoltValue block="get sound volt value"
    //% weight = 85
